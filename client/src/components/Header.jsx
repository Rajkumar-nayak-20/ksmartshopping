...
const Header = () => {
  ...
  return (
//     <header className="sticky top-0 z-50 px-8 lg:px-16 py-4 bg-linear-to-b from-/90 to-transparent backdrop-blur-2xl border-b border-[#222]/50">
...
//       {/* Search – Desktop */}
//       <div className="hidden lg:block w-full max-w-2xl mx-10">
//         <Search />
//       </div>
...
//         {/* Mobile User Icon */}
//         <button
//           className="lg:hidden text-gray-600 hover:text-[#00a040] transition"
...
//                   <div className="bg-white rounded-2xl p-5 min-w-60 shadow-2xl border border-gray-100">
        ...
        <div className="hidden lg:flex items-center gap-4">
          ...
          {user?._id ? (
            <div className="relative">
              ...
              >
                ...
                {openUserMenu ? (
                  <GoTriangleUp className="text-gray-500 group-hover:text-gray-700" size={16} />
                ) : (
                  <GoTriangleDown className="text-gray-500 group-hover:text-gray-700" size={16} />
                )}
              </button>
          ...
          <button className="relative group">
            <div className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-emerald-600 to-green-600 hover:from-emerald-700 hover:to-green-700 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200">
              <BsCart4 size={20} className="text-white/90 group-hover:scale-110 transition-transform animate-bounce" />
