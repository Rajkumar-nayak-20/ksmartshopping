      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-5 lg:px-8 flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1">
          ...
          <div className="bg-white rounded-xl shadow-sm p-3 sm:p-4 space-y-3">
            ...
            <div
              onClick={() => setOpenAddress(true)}
              className="border-2 border-dashed rounded-lg p-5 text-center cursor-pointer hover:bg-green-50 transition"
            >
        ...
        <div className="w-full lg:max-w-md">
          ...
          <div className="bg-white rounded-xl shadow-sm p-4 sticky top-4">
            ...
            <div className="mt-4 flex flex-col gap-3">
              ...
              <button
                onClick={handleCashOnDelivery}
                className="w-full py-3 border-2 border-green-600 text-green-600 rounded-lg font-semibold hover:bg-green-600 hover:text-white transition"
              >
                Cash on Delivery
              </button>
